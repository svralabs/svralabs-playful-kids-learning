...
{/*  TopNavBar Component (Mobile Only)  */}
...
{/*  2. Card Skeleton Variant (Square)  */}
...
{/*  3. List Skeleton Variant (Square)  */}
<div className="md:col-span-6 bg-surface-container-low rounded-xl p-cell-padding shadow-sm">
<h3 className="font-headline-md text-headline-md text-on-surface mb-6 flex items-center gap-2">
...
{/*  4. Loading Spinners & Progress (Wide)  */}
