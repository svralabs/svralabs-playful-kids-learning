...
{/*  Math: 2x2 Cell (md:col-span-8 md:row-span-2)  */}
...
{/*  Science: 1x1 Cell (md:col-span-4 md:row-span-1)  */}
...
{/*  Art: 1x1 Cell (md:col-span-4 md:row-span-1)  */}
...
{/*  Language: 2x1 Cell (md:col-span-6 md:row-span-1)  */}
...
{/*  Daily Challenge: 2x1 Cell (md:col-span-6 md:row-span-1)  */}
