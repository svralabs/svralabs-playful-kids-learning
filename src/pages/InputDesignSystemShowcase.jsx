...
<li>
{/*  Active State Logic applied to 'Patterns' as it's the closest semantic match for a component showcase  */}
...
{/*  Large Input uses explicit 32px radius and larger text/padding  */}
