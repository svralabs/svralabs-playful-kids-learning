...
{/*  Header Bento Cell  */}
<header className="bg-surface-container-low rounded-xl p-cell-padding flex flex-col md:flex-row gap-gutter items-start md:items-center relative overflow-hidden border-2 border-surface-variant" style={{ "-PatternColor": "#e6e0ee" }}>
...
{/*  Section 1: Anatomy (Spans 8 cols)  */}
<section className="md:col-span-8 bg-surface-container rounded-xl p-cell-padding border-2 border-surface-variant relative overflow-hidden" style={{ "-PatternColor": "#cac3d8" }}>
...
{/*  Section 3: Placement (Spans 4 cols)  */}
...
{/*  Section 2: Functional Variants (Spans 12 cols)  */}
